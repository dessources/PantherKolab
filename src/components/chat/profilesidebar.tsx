    ...
    <div className="w-96 bg-white border-l border-gray-200 flex flex-col overflow-y-auto">
      ...
      <div className="px-6 mt-6 grid grid-cols-4 gap-4">
        {[
          ...
          >
            <div className="p-3 bg-[#0066CC] rounded-lg">{btn.icon}</div>
      ...
      <div className="px-6 py-6">
        ...
        <p className="text-sm font-bold text-gray-900">{profileData.status}</p>
      </div>
        ...
        <div className="px-6 py-6">
          ...
          <div className="space-y-4">
            {profileData.groupsInCommon.map((group, index) => (
              <div key={index} className="pb-2 border-b last:border-none">
